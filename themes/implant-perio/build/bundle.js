...
/* harmony import */ var _modules_GoogleMap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/GoogleMap */ "./assets/js/modules/GoogleMap.js");
/* harmony import */ var _modules_TeamBio__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/TeamBio */ "./assets/js/modules/TeamBio.js");
/* harmony import */ var _modules_Faqs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/Faqs */ "./assets/js/modules/Faqs.js");
/* harmony import */ var _modules_Headroom__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/Headroom */ "./assets/js/modules/Headroom.js");
/* harmony import */ var _modules_Headroom__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_Headroom__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _modules_MenuHover__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/MenuHover */ "./assets/js/modules/MenuHover.js");
...
const teamBio = new _modules_TeamBio__WEBPACK_IMPORTED_MODULE_3__["default"]();
const faq = new _modules_Faqs__WEBPACK_IMPORTED_MODULE_4__["default"]();
const menu = new _modules_MenuHover__WEBPACK_IMPORTED_MODULE_6__["default"]();

// call any auxillary functions
(function () {
  // check if headroom works on the browser and then add sticky to the navigation

  if ((_modules_Headroom__WEBPACK_IMPORTED_MODULE_5___default().cutsTheMustard)) {
    ...
    const stickyNav = new (_modules_Headroom__WEBPACK_IMPORTED_MODULE_5___default())(document.querySelector('.headroom-nav'), options);
    stickyNav.init();
  }

  // slick initalise
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('#review-mosaic-slider.has-slides').slick({
    infinite: false,
    slidesToShow: 1,
    slidesToScroll: 1,
    dots: true,
...
/***/ "./assets/js/modules/BeforeAfter.js":
/*!******************************************!*\
  !*** ./assets/js/modules/BeforeAfter.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#slider').on('input change', function (e) {
  const $parent = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('.image-container');
  let value = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val(); // Get the current slider value
...
/***/ "./assets/js/modules/GoogleMap.js":
/*!****************************************!*\
  !*** ./assets/js/modules/GoogleMap.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./assets/js/modules/MenuHover.js":
/*!****************************************!*\
  !*** ./assets/js/modules/MenuHover.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class MenuHover {
  ...
  constructor() {
    ...
    this.nav = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#site-nav');
    this.navItems = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#site-nav .has-children');
    this.overlay = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.body-overlay');
    this.toggle = false;
    this.events();
  }
  ...
  // methods
  navEnter(e) {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).width() > 1100 && this.nav.offset().top !== 0) {
      if (!this.toggle) {
  ...
  navLeave(e) {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).width() > 1100 && this.navOffsetTop !== 0) {
      if (this.toggle) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (MenuHover);

/***/ }),

/***/ "./assets/js/modules/TeamBio.js":
/*!**************************************!*\
  !*** ./assets/js/modules/TeamBio.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class TeamBio {
  // constructor
  constructor() {
    this.teamCards = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.team-member-card');
    this.closeIcon = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.bio-close-icon');
    this.overlay = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.team-member-bios');
  ...
  events() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('keydown', this.keyClose.bind(this));
  }
  ...
  activateBio(e) {
    ...
    const bio = jquery__WEBPACK_IMPORTED_MODULE_0___default()(`.team-member-bio-card[data-team="${data['team']}"]`);
    bio.addClass('active');
    this.overlay.addClass('active');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').addClass('bio-locked');
    this.teamToggle = true;
  }
  overlayClose(e) {
    if (!this.teamToggle || !jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).is(this.overlay)) {
      return;
    }
    this.hideBio(e);
  }
  ...
  hideBio(e) {
    const bioCard = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.team-member-bio-card.active');
    bioCard.removeClass('active');
    this.overlay.removeClass('active');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').removeClass('bio-locked');
    this.teamToggle = false;
  }
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TeamBio);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkdefault_wp_js"] = self["webpackChunkdefault_wp_js"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-main"], () => (__webpack_require__("./assets/js/index.js")))
