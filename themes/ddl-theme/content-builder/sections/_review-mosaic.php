        ...
        <div class="wrapper flex-row">
            ...
            <div class="main-content">
                ...
                <div class="top-content flex-row">
                    ...
                    <!-- image slider -->
                    <div class="slider-container" id="review-mosaic-slider">
                        <?php foreach ($images as $image) : ?>
                            
                            <div class="image-slide">
                                <img data-source="<?= esc_url(wp_get_attachment_image_url($image['id'], $image_size)); ?>" alt="<?= !empty($image['alt'] ? $image['alt'] : 'Process image No.' . $imageCounter)?>" height="742" width="627" />
                            </div>
                ...
                <div class="bottom-content flex-row">
                    ...
                    <div class="reviews-container bg-medium-grey">
                    ...
                    <div class="text-container">
                        <div class="text-container-inner">
                            ...
                            <?php if (!empty($bottomText['heading'])) : ?>
                                <h2 class="add-margin text-white"><?= $bottomText['heading']; ?></h2>
                            <?php endif; ?>
                            ...
                            <?php if (!empty($bottomText['button'])) : ?>
                                <a href="<?= esc_attr($bottomText['button']['url']); ?>" class="transparent-button button" aria-label="<?= $bottomText['heading']; ?>"><?= $bottomText['button']['title']; ?></a>
                            <?php endif; ?>
