...
<section class="page-banner bg-medium-grey">
    <div class="banner-image bg-image container add-margin large" style="background-image: url('<?= esc_attr(has_post_thumbnail() ? wp_get_attachment_image_url($image, $image_size) : get_theme_file_uri('assets/images/default-image.png')) ?>');">
